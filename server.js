...
let serviceAccount = require("./ecom-website-5106e-firebase-adminsdk-ayltb-55190128b9.json");
   ...
   //form validations
      if(name.length<3){
        ...
        return res.json({'alert': 'enter your email'});
         ...
         return res.json({'alert':'password strength is low, use 8 letters long'});
...
app.post('/seller', (req, res) =>{
    ...
    if(!name.length || !address.length || !about.length || number.length<10  ||!Number(number)){
        ...
        // update users seller satuts here.
